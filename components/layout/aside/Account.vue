...
<template>
	...
	>
		<UserImage
			...
			:px="44"
		/>
		<div class="hidden flex-col items-start xl:flex justify-center overflow-hidden">
			<span class="font-bold text-nowrap overflow-ellipsis">{{ currentUser.profile!.name }}</span>
	...
	<Popover ref="op">
		<button
			class="w-48 font-bold text-left"
			@click="logout"
		>
